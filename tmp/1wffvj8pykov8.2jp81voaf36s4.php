...
" ?>
									...
									<div class="card-body">
                                      <!--begin::Wizard Form-->
                                        <form id="submit-form" method="<?= ($method) ?>" action="<?= ($BASE) ?>/user">
                                                ...
                                                <div class="col-xl-9">
                                                    ...
                                                    <div class="my-5 step" data-wizard-type="step-content" data-wizard-state="current">
                                                        ...
                                                        <div class="form-group row">
                                                            <label for="product_name" class="col-xl-3 col-lg-3 col-form-label la">ຮູບ</label>
                                                            <div class="col-lg-9 col-xl-3">
                                                                <input type="hidden" name="profile_avatar" value="<?= ($item->profile_avatar ?? '') ?>" />
                                                                <div class="upload-drop-zone dropzone" id="profile-avatar">
                                                                    <?php if ($item->profile_avatar ?? '' != ''): ?>
                                                                        
                                                                            <img src="<?= ($item->profile_avatar) ?>" alt="<?= ($item->first_name) ?>" class="img-fluid" width="50">
                                                                            <input type="hidden" name="profile_avatar" value="<?= ($item->profile_avatar ?? '') ?>" />
...
" ?>
                                                        ...
                                                        <div class="form-group row la">
                                                            <label class="col-xl-2 col-lg-2 col-form-label">ຕຳແໜ່ງ</label>
                                                            <div class="col-lg-9 col-xl-9">
                                                        ...
                                                        <div class="form-group row la">
                                                            <label class="col-xl-2 col-lg-2 col-form-label">ຫ້ອງສອນ</label>
                                                            <div class="col-lg-9 col-xl-9">
...
" ?>
                                                        ...
                                                        <div class="form-group row la">
                                                            <label class="col-xl-2 col-lg-2 col-form-label">ລະຫັດຜ່ານ</label>
                                                            <div class="col-lg-9 col-xl-9">
                                                                <input class="form-control form-control-solid form-control-lg"  name="password" type="text" />
                                                            </div>
                                                        </div>
                                                        <div class="form-group row la">
                                                            <label class="col-xl-2 col-lg-2 col-form-label">ຢືນ​ຢັນ​ລະຫັດຜ່ານ</label>
                                                            <div class="col-lg-9 col-xl-9">
                                                                <input class="form-control form-control-solid form-control-lg" name="confirm_password" type="text"/>
                                                            </div>
                                                        </div>
                                                        <div class="form-group row la">
                                                            <label class="col-xl-2 col-lg-2 col-form-label">ທີ່​ຢູ່​ອີ​ເມວ</label>
                                                            <div class="col-lg-9 col-xl-9">
                                                                <div class="input-group input-group-solid input-group-lg">
                                                                    ...
                                                                    <input type="email" class="form-control form-control-solid form-control-lg" name="email" value="<?= ($item->email ?? '') ?>"/>
                                                                    </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="d-flex justify-content-between border-top pt-10 mt-15">
                                                        <div class="mr-2"></div>
                                                        <div>
                                                            <a href="<?= ($BASE) ?>/user" class="btn btn-default font-weight-bolder px-9 py-4">Cancel <i class="fa"></i></a>
		...
		<script type="text/javascript">
		 ...
		 // Dropzone box 1
            new Dropzone("#profile-avatar", {
            url: "<?= ($BASE) ?>/upload-user-image",
            paramName: "image",
            maxFiles: 1,
            maxFilesize: 10, // MB
            addRemoveLinks: true,
            ...
            if (response.success == true) {
                var input = "<input type='hidden' name='profile_avatar' value='" + response.file_name + "'/>";
                $('#profile-avatar').append(input);
            } else {
